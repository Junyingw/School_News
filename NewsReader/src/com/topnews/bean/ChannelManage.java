...
public class ChannelManage {
	...
	static {
		...
		defaultUserChannels.add(new ChannelItem(1, "学校", 1, 1));
		defaultUserChannels.add(new ChannelItem(2, "教务", 2, 1));
		defaultUserChannels.add(new ChannelItem(3, "学院", 3, 1));
		defaultUserChannels.add(new ChannelItem(4, "考研", 4, 1));
		defaultUserChannels.add(new ChannelItem(5, "兼职", 5, 1));
		defaultUserChannels.add(new ChannelItem(6, "社团", 6, 1));
		defaultUserChannels.add(new ChannelItem(7, "招聘", 7, 1));
		defaultOtherChannels.add(new ChannelItem(8, "兴趣", 1, 0));
		defaultOtherChannels.add(new ChannelItem(9, "交友", 2, 0));
		defaultOtherChannels.add(new ChannelItem(10, "创业", 3, 0));
		defaultOtherChannels.add(new ChannelItem(11, "社会", 4, 0));
		defaultOtherChannels.add(new ChannelItem(12, "旅游", 5, 0));
		defaultOtherChannels.add(new ChannelItem(13, "娱乐", 6, 0));
